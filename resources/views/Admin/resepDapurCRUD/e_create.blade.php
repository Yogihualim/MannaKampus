...
<form action="{{ route('info_lowongan.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>Nama Info Lowongan:</strong>
                <input type="text" name="nama_info_lowongan" class="form-control" placeholder="Info Lowongan Name">
