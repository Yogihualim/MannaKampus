            ...
            <div class="row gx-4 gx-lg-5">
                ...
                <div class="col-lg-9 col-md-6 text-start">
                    <ul class="breadcrumb text-dark ps-2">
                        ...
                        <li class="breadcrumb-item active"><u>Manna Kampus Mini Diro</u></li>
                    </ul>
                    <hr>
                    <!-- Map container -->
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Manna Kampus Mini Diro mulai beroperasi mulai tahun 2021. Manna Kampus Mini Diro merupakan bagian usaha Manna Kampus
                            yang berbentuk minimarket. Manna Kampus Mini Diro merupakan cabang minimarket kedua yang dikelola oleh manajemen Manna Kampus.
                            <br><br>
                            <i class="bi-signpost-split pe-0"></i>
                                Jl. Bantul No.8, Diro, Pendowoharjo, Kec. Sewon, Kabupaten Bantul, Daerah Istimewa Yogyakarta 55186
                            <br><br>
                            <i class="bi-signpost-split pe-0"></i>
                                Telp: 085900484760
                            <br><br>
